...
static void printDemo(int feld[3][4])
{
}

static void printDemo2(int feld[][4], int rows)
{
    for (int i = 0; i != rows; ++i) {

        for (int k = 0; k != 4; ++k) {

            printf("%d:%d: %3d     ", i, k, feld[i][k]);
        }
        printf("\n");
    }
}

static void printDemo3(int* feld, int rows, int cols)
{
    for (int i = 0; i != rows; ++i) {
        ...
        for (int k = 0; k != 4; ++k) {
            ...
            printf("%d:%d: %3d     ", i, k, feld[index]);
        }
        printf("\n");
    }
}

static void multidimensional_arrays_000()
{
    // 3 Reihen // 4 Spalten
    int x1[3][4] =
    {
    ...
    int x2[6][4] = { 1, 2, 3, 4, 10, 11, 12, 13, 20,21, 22, 23,  1, 2, 3, 4, 10, 11, 12, 13, 20,21, 22, 23 };

   // printDemo2(x2, 6);

    printDemo3(&x2[0][0], 6, 3);
}
